...
export const dhi = {
  ...
  imgdesc: 'Description of the GreenUp project by DHI',
  ...
  <>
    <p style={{ textAlign: 'left' }}>
        ...
        <Image src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' rounded alt='TypeScript logo' />{' '}
        <Image src='https://img.shields.io/badge/react-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB' rounded alt='React logo' />{' '}
        <Image src='https://img.shields.io/badge/FastAPI-005571?style=for-the-badge&logo=fastapi' rounded alt='FastAPI logo' />{' '}
    </p>
  </>,
Content: 
  <>
        ...
        target='_blank' rel='noopener noreferrer'>
            <OverlayTrigger key='top' placement='top' overlay={
                <Tooltip id='tooltip-top'>
                    Link to the LinkedIn post about the collaboration
                </Tooltip>
            }>
